%% Dynamic plotting: N metric files -> N Separate Figures
...
% ====== SET FOLDER PATH ======
dataDir = 'D:\ElectricalEngineering\#0 Graduation project\The Project\afterUpdate\Graduation-Project-QtUpdated\seperateFigures';
...
for k = 1:N
    ...
    % --- 3. FORMATTING (Applied to this specific figure) ---
